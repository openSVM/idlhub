/**
 * Pure JS SPL Token utilities
 * Replaces @solana/spl-token to eliminate bigint-buffer vulnerability (CVE-2025-3194)
 */

import { PublicKey, TransactionInstruction, SystemProgram, Keypair, Transaction, sendAndConfirmTransaction } from '@solana/web3.js';
 ...
 */
export function unpackMint(data) {
  if (data.length < 82) {
 ...
 */
export function unpackAccount(data) {
  if (data.length < 165) {
